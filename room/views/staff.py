...
class AdminCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        user.save()
        messages.success(self.request, 'Аккаунт админа создан!')
...
class SubjectCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        subject.save()
        messages.success(self.request, 'Секция изменена!')
...
class TeacherListView(ListView):
    ...
    extra_context = {
        'title': 'Представители организаторов',
...
def accept_course(request, course_pk):
    ...
    messages.success(request, 'Мероприятие утверждено.')
...
def anal(request):
    ...
    return render(request, 'classroom/staff/dashboard_anal.html', context)
...
def deactivate_admin(request, pk):
    ...
    messages.success(request, 'Аккаунт админа удален.')
    return redirect('staff:admin_list')
...
def deactivate_student(request, pk):
    ...
    messages.success(request, 'Аккаунт участника удален.')
...
def deactivate_teacher(request, pk):
    ...
    messages.success(request, 'Аккаунт представителя удален.')
...
def delete_log(request, pk):
    ...
    messages.success(request, 'Действие пользователя удалено.')
...
def get_user_activities(request):
    select_data = {"action_date": "strftime('%%d-%%m-%%Y', datetime(created_at, 'localtime'))"}
